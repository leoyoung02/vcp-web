...
export const routes: Routes = [
    ...
    {
        path: 'speed-networking-3/:invite',
        data: { layout: PageLayout.Blank, titleKey: 'SPEED NETWORKING' },
        title: CustomTitleResolver,
        loadComponent: async () => (await import('@features/plans/category/category.component')).PlanCategoryComponent,
        canMatch: [authGuard({ requiresAuthentication: false })],
    },
    {
        path: 'gar-grupos-de-alto-rendimiento/:invite',
        data: { layout: PageLayout.Blank, titleKey: 'GAR - GRUPO DE ALTO RENDIMIENTO' },
        title: CustomTitleResolver,
        loadComponent: async () => (await import('@features/plans/category/category.component')).PlanCategoryComponent,
        canMatch: [authGuard({ requiresAuthentication: false })],
    },
    {
        path: 'eat-meet/:invite',
        data: { layout: PageLayout.Blank, titleKey: 'EAT AND MEET' },
        title: CustomTitleResolver,
        loadComponent: async () => (await import('@features/plans/category/category.component')).PlanCategoryComponent,
        canMatch: [authGuard({ requiresAuthentication: false })],
    },
    {
        path: 'talleres-de-herramientas-digitales/:invite',
        data: { layout: PageLayout.Blank, titleKey: 'TALLERES DE HERRAMIENTAS DIGITALES' },
        title: CustomTitleResolver,
        loadComponent: async () => (await import('@features/plans/category/category.component')).PlanCategoryComponent,
        canMatch: [authGuard({ requiresAuthentication: false })],
    },
    {
        path: 'internos/:invite',
        data: { layout: PageLayout.Blank, titleKey: 'INTERNOS' },
        title: CustomTitleResolver,
        loadComponent: async () => (await import('@features/plans/category/category.component')).PlanCategoryComponent,
        canMatch: [authGuard({ requiresAuthentication: false })],
    },
    {
        path: 'networking-eat-meet/:invite',
        data: { layout: PageLayout.Blank, titleKey: 'NETWORKING + EAT AND MEET' },
        title: CustomTitleResolver,
        loadComponent: async () => (await import('@features/plans/category/category.component')).PlanCategoryComponent,
        canMatch: [authGuard({ requiresAuthentication: false })],
    },
    ...
    },
    {
        path: 'credits',
        data: { layout: PageLayout.Main },
        loadChildren: async () => (await import('@pages/credits')).routes,
        canMatch: [authGuard()],
    },
    {
        path: 'support-tickets',
        data: { layout: PageLayout.Main },
        loadChildren: async () => (await import('@pages/support-tickets')).routes,
        canMatch: [authGuard()],
    },
    {
        path: 'settings',
